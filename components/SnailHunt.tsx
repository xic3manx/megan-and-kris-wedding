        ...
        {showReward && (
          ...
          >
            ...
            >
              ...
              {/* Inline YouTube embed — Kris confirmed the uploader's
                  share dialog now provides an iframe URL with an `si`
                  token, so embedding is permitted. Plays in-page;
                  the "Open on YouTube" fallback below is there in
                  case a future restriction breaks the iframe. */}
              <div className="mx-auto mb-2" style={{ maxWidth: 260 }}>
                <div
                  className="relative w-full overflow-hidden rounded border border-[var(--color-gold-deep)]/40 bg-[var(--color-ink-deep)]"
                  style={{ aspectRatio: "9 / 16" }}
                >
                  <iframe
                    src="https://www.youtube.com/embed/o2ACpKW9YjQ?si=DVb_M3ITeKultgrR"
